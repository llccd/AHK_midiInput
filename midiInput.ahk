...
MidiSet() {
  ...
  Gui, 4: Add, Button, x10 w105 gSetDone, Done
...
MidiMsgDetect(hInput, midiMsg, wMsg) {
    ...
    MidiRules(statusbyte, chan, data1, data2, stb, pitchb)
}
...
#Include %A_LineFile%\..\midiRules.ahk